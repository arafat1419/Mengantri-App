 ...
 * Use the [CompanyEditProfileFragment.newInstance] factory method to
...
class CompanyEditProfileFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CompanyEditProfileFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CompanyEditProfileFragment().apply {
